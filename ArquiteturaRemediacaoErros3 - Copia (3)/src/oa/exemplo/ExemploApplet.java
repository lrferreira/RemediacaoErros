...
/*
	...
	private void makeRules() {
		...
		RulesFactory.createRules(
				...
				new MERFunction(), 
				new MultipleExternalRepresentation(++i, "compreensao_aprofundada.png", "Texto exibindo os principais conceitos aritm�ticos para retomar a base conceitual do aprendiz"),
				-1);
	...
	private void initComponents() {
		...
		textPane.setBounds(494, 36, 667, 528);
		panel.add(textPane);
