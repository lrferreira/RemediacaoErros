...
*/
	...
	public static RuleInformation ruleMERCriterionSpecific(Criterion crit, MultipleExternalRepresentation mer, boolean specific) {
		...
		if (specific)
			r.getConditions().add("action.getRemediation().getMer().getId().equals(" + mer.getId() + "L);");
		else
			r.getConditions().add("!(action.getRemediation().getMer().getId().equals(" + mer.getId() + "L));");

		r.getConditions().add("action.getRemediation().getCriterion().getId().equals(" + crit.getId() + "L);");
