...
import java.util.ArrayList;
 ...
 class Jeops_RuleBase_MERManagerSpecificMERKB extends jeops.AbstractRuleBase {
    ...
    /**
     * Identifiers of rule ruleMER_2_criterion_1_0
     */
    private String[] identifiers_ruleMER_2_criterion_1_0 = {
        "action",
        "dbCon",
        "mer",
        "ruleToHuman"
    ...
    /**
     * Returns the identifiers declared in rule ruleMER_2_criterion_1_0
     *
     * @return the identifiers declared in rule ruleMER_2_criterion_1_0
     */
    private String[] getDeclaredIdentifiers_ruleMER_2_criterion_1_0() {
         return identifiers_ruleMER_2_criterion_1_0;
    }
     ...
     *          this rule.
     */
    private String getDeclaredClassName_ruleMER_2_criterion_1_0(int index) {
        switch (index) {
    ...
    /**
     * Returns the class of one declared object for rule ruleMER_2_criterion_1_0.
     *
     * @param index the index of the declaration
     * @return the class of the declared objects for this rule.
     */
    private Class getDeclaredClass_ruleMER_2_criterion_1_0(int index) {
        switch (index) {
    ...
    /**
     * Sets an object declared in the rule ruleMER_2_criterion_1_0.
     *
     * @param index the index of the declared object
     * @param value the value of the object being set.
     */
    private void setObject_ruleMER_2_criterion_1_0(int index, Object value) {
        switch (index) {
    ...
    /**
     * Returns an object declared in the rule ruleMER_2_criterion_1_0.
     *
     * @param index the index of the declared object
     * @return the value of the corresponding object.
     */
    private Object getObject_ruleMER_2_criterion_1_0(int index) {
        switch (index) {
     ...
     * of rule ruleMER_2_criterion_1_0
     *
     * @return an object array of the variables bound to the
     *          declarations of this rule.
     */
    private Object[] getObjects_ruleMER_2_criterion_1_0() {
        return new Object[] {
     ...
     *          declarations of this rule.
     */
    private void setObjects_ruleMER_2_criterion_1_0(Object[] objects) {
    ...
    /**
     * Condition 0 of rule ruleMER_2_criterion_1_0.<p>
     ...
     */
    private boolean ruleMER_2_criterion_1_0_cond_0() {
        return (module_entity_Action_1.getRemediation().getMer().getId().equals(2L));
    }

    /**
     * Condition 1 of rule ruleMER_2_criterion_1_0.<p>
     * The original expression was:<br>
     ...
     *          <code>false</code> otherwise.
     */
    private boolean ruleMER_2_criterion_1_0_cond_1() {
        return (module_entity_Action_1.getRemediation().getCriterion().getId().equals(1L));
    }

    /**
     * Checks whether some conditions of rule ruleMER_2_criterion_1_0 is satisfied.
     *
     * @param index the index of the condition to be checked.
     * @return <code>true</code> if the condition is satisfied;
     *          <code>false</code> otherwise.
     */
    private boolean ruleMER_2_criterion_1_0_cond(int index) {
        switch (index) {
            case 0: return ruleMER_2_criterion_1_0_cond_0();
            case 1: return ruleMER_2_criterion_1_0_cond_1();
            default: return false;
        }
    }

    /**
     * Checks whether all conditions of rule ruleMER_2_criterion_1_0 that depend only on
     ...
     */
    private boolean checkConditionsOnlyOf_ruleMER_2_criterion_1_0(int declIndex) {
        switch (declIndex) {
            case 0:
                if (!ruleMER_2_criterion_1_0_cond_0()) return false;
                if (!ruleMER_2_criterion_1_0_cond_1()) return false;
                return true;
            case 1:
                return true;
            case 2:
     ...
     *          <code>false</code> otherwise.
     */
    private boolean checkCondForDeclaration_ruleMER_2_criterion_1_0(int declIndex) {
        switch (declIndex) {
            case 0:
                return true;
            case 1:
    ...
    /**
     * Executes the action part of the rule ruleMER_2_criterion_1_0
     */
    private void ruleMER_2_criterion_1_0() {
			module_entity_Action_1.getRegrasAcionadas().add("ruleMER_2_criterion_1_");
			module_entity_RuleToHuman_1.setDescription(module_entity_RuleToHuman_1.getDescription() + "Regra acionada para selecionar a MRE: ruleMER_2_criterion_1_ \n");
...
// end_rules
    ...
    public boolean checkCondition(int ruleIndex, int condIndex) {
        switch (ruleIndex) {
            case 0: return ruleMER_2_criterion_1_0_cond(condIndex);
            default: return false;
        }
    }
    ...
    public boolean checkConditionsOnlyOf(int ruleIndex, int declIndex) {
        switch (ruleIndex) {
            case 0: return checkConditionsOnlyOf_ruleMER_2_criterion_1_0(declIndex);
            default: return false;
        }
    }
    ...
    public boolean checkCondForDeclaration(int ruleIndex, int declIndex) {
        switch (ruleIndex) {
            case 0: return checkCondForDeclaration_ruleMER_2_criterion_1_0(declIndex);
            default: return false;
        }
    }
    ...
    public String getDeclaredClassName(int ruleIndex, int declIndex) {
        switch (ruleIndex) {
            case 0: return getDeclaredClassName_ruleMER_2_criterion_1_0(declIndex);
            default: return null;
        }
    }
    ...
    public Class getDeclaredClass(int ruleIndex, int declIndex) {
        switch (ruleIndex) {
            case 0: return getDeclaredClass_ruleMER_2_criterion_1_0(declIndex);
            default: return null;
        }
    }
    ...
    protected void internalFireRule(int ruleIndex) {
        switch (ruleIndex) {
            case 0: ruleMER_2_criterion_1_0(); break;
        }
    }
    ...
    public String[] getDeclaredIdentifiers(int ruleIndex) {
        switch (ruleIndex) {
            case 0: return getDeclaredIdentifiers_ruleMER_2_criterion_1_0();
    ...
    public void setObject(int ruleIndex, int declIndex, Object value) {
        switch (ruleIndex) {
            case 0: setObject_ruleMER_2_criterion_1_0(declIndex, value); break;
        }
    }
    ...
    public Object getObject(int ruleIndex, int declIndex) {
        switch (ruleIndex) {
            case 0: return getObject_ruleMER_2_criterion_1_0(declIndex);
            default: return null;
        }
    }
    ...
    public Object[] getObjects(int ruleIndex) {
        switch (ruleIndex) {
            case 0: return getObjects_ruleMER_2_criterion_1_0();
            default: return null;
        }
    }
    /**
    ...
    public void setObjects(int ruleIndex, Object[] objects) {
        switch (ruleIndex) {
            case 0: setObjects_ruleMER_2_criterion_1_0(objects); break;
        }
    }
