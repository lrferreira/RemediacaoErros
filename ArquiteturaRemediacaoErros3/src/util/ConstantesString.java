...
public class ConstantesString {
	...
	public static final String IMPORT_HISTORICO = "import entity.Historic";
	public static final String IMPORT_ACTION = "import entity.Action";
	public static final String IMPORT_STUDENT = "import entity.Student";
	public static final String IMPORT_MER = "import entity.MultipleExternalRepresentation";
	public static final String IMPORT_ANSWER = "import entity.Answer";
	public static final String IMPORT_CORECTANSWER = "import entity.CorrectAnswer";
