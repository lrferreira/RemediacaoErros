...
public class Constants {
	...
	public static final Long CRITERIO_MRE_ESPECIFICA_ERRO = 1L;
	public static final Long CRITERIO_NAO_USAR_MRE_ESPECIFICA = 2L;
	public static final Long CRITERIO_PERSISTENCIA_ERRO = 3L;
	public static final Long CRITERIO_ALTERNAR_ENTRE_MRE_TIPO_ESPECIFICADO = 4L;
	public static final Long CRITERIO_COMPLEXIDADE = 5L;
	public static final Long CRITERIO_SUCESSOS_ANTERIORES_MRE = 6L;
	
	public static final Long TRATAMENTO_RESPOSTA_ESPECIFICA = 1L;
	public static final Long TRATAMENTO_QUALQUER_RESPOSTA = 2L;
