 ...
 class Jeops_RuleBase_GerenciadorMREBaseRegras extends jeops.AbstractRuleBase {
    ...
    private String getDeclaredClassName_MRE1(int index) {
        switch (index) {
            ...
            case 1: return "entidades.FuncaoMRE";
            case 2: return "entidades.RespostaErrada";
    ...
    private Class getDeclaredClass_MRE1(int index) {
        switch (index) {
            ...
            case 1: return entidades.FuncaoMRE.class;
            case 2: return entidades.RespostaErrada.class;
    ...
    private void setObject_MRE1(int index, Object value) {
        switch (index) {
            ...
            case 1: this.entidades_FuncaoMRE_1 = (entidades.FuncaoMRE) value; break;
            case 2: this.entidades_RespostaErrada_1 = (entidades.RespostaErrada) value; break;
    ...
    private void setObjects_MRE1(Object[] objects) {
        ...
        entidades_FuncaoMRE_1 = (entidades.FuncaoMRE) objects[1];
        entidades_RespostaErrada_1 = (entidades.RespostaErrada) objects[2];
