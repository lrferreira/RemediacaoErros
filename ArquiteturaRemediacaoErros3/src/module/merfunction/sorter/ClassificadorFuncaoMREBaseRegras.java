 ...
 class Jeops_RuleBase_ClassificadorFuncaoMREBaseRegras extends jeops.AbstractRuleBase {
    ...
    private String getDeclaredClassName_papeisComplementares(int index) {
        switch (index) {
            ...
            case 2: return "entity.MERFunction";
            default: return null;
        }
    }
    ...
    private Class getDeclaredClass_papeisComplementares(int index) {
        switch (index) {
            ...
            case 2: return entity.MERFunction.class;
            default: return null;
        }
    }
    ...
    private void setObject_papeisComplementares(int index, Object value) {
        switch (index) {
            ...
            case 1: this.entidades_RespostaErrada_1 = (entity.WrongAnswer) value; break;
            case 2: this.entidades_FuncaoMRE_1 = (entity.MERFunction) value; break;
        }
    }
    ...
    private void setObjects_papeisComplementares(Object[] objects) {
        ...
        entidades_RespostaErrada_1 = (entity.WrongAnswer) objects[1];
        entidades_FuncaoMRE_1 = (entity.MERFunction) objects[2];
    }
