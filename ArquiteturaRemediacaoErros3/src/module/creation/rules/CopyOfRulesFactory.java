...
public class CopyOfRulesFactory {
	...
	*/
	...
	public static RuleInformation ruleMisinterpretation(Goal goal, WrongAnswer wrongAnswer) {
		...
		//r.getActions().add("modified(action);");
		r.getActions().add("System.out.println(\"Erro classificado como Interpreta��o Equivocada\");");
	...
	public static RuleInformation ruleDirectlyIdentifiableDeficiencyDomain(Goal goal, WrongAnswer wrongAnswer) {
		...
		//r.getActions().add("action.setAttempt(action.getAttempt() + 1);");
		//r.getActions().add("modified(action);");
		r.getActions().add("System.out.println(\"Erro classificado como Diretamente Identific�vel - Defici�ncia no Dom�nio\");");		
	...
	public static RuleInformation ruleDirectlyIdentifiableDeficiencyRule(Goal goal, WrongAnswer wrongAnswer) {
		...
		//r.getActions().add("action.setAttempt(action.getAttempt() + 1);");
		//r.getActions().add("modified(action);");
		r.getActions().add("System.out.println(\"Erro classificado como Diretamente Identific�vel - Defici�ncia na Regra\");");		
	...
	public static RuleInformation ruleDirectlyIdentifiableDeficiencyOperatorChoice(Goal goal, WrongAnswer wrongAnswer) {
		...
		//r.getActions().add("action.setAttempt(action.getAttempt() + 1);");
		//r.getActions().add("modified(action);");
		r.getActions().add("System.out.println(\"Erro classificado como Diretamente Identific�vel - Defici�ncia na Escolha do Operador\");");		
	...
	public static RuleInformation ruleIndirectlyIdentifiable(Goal goal, WrongAnswer wrongAnswer) {
		...
		//r.getActions().add("action.setAttempt(action.getAttempt() + 1);");
		//r.getActions().add("modified(action);");
		r.getActions().add("System.out.println(\"Erro classificado como Indiretamente Identific�vel\");");		
	...
	public static RuleInformation ruleSolutionNonCategorizable(Goal goal, WrongAnswer wrongAnswer) {
		...
		//r.getActions().add("action.setAttempt(action.getAttempt() + 1);");
		//r.getActions().add("modified(action);");
		r.getActions().add("System.out.println(\"Erro classificado como Solu��o N�o Categoriz�vel\");");		
	...
	public static RuleInformation ruleComplementaryRoles(Goal goal) {
		...
		r.getActions().add("ruleToHuman.setDescription(ruleToHuman.getDescription() + \" \\t Tipo de Erro = Interpreta��o Equivocada \\n\");");		
		//r.getActions().add("action.setAttempt(action.getAttempt() + 1);");
		//r.getActions().add("modified(action);");
		r.getActions().add("merFunction.setType(Constants.TIPO_FUNCAOMRE_PAPEIS_COMPLEMENTARES);");
		r.getActions().add("modified(merFunction);");
		r.getActions().add("modified(ruleToHuman);");
		r.getActions().add("System.out.println(\"Fun��o MRE: Pap�is Complementares\");");
		r.getActions().add("flush();");
	...
	public static RuleInformation ruleConstrainInterpretation01(Goal goal) {
		...
		r.getActions().add("ruleToHuman.setDescription(ruleToHuman.getDescription() + \"Regra acionada para classificar a Fun��o da MRE: " + r.getRuleName() + " \\n\");");
		r.getActions().add("ruleToHuman.setDescription(ruleToHuman.getDescription() + \" Condi��es:  \\n\");");
		r.getActions().add("ruleToHuman.setDescription(ruleToHuman.getDescription() + \" \\t Tipo de Erro = Diretamente Identific�vel - Defici�ncia no Dom�nio \\n\");");			
		//r.getActions().add("action.setAttempt(action.getAttempt() + 1);");
		//r.getActions().add("modified(action);");
		r.getActions().add("merFunction.setType(Constants.TIPO_FUNCAOMRE_RESTRICAO_INTERPRETACAO);");
		r.getActions().add("modified(merFunction);");
		r.getActions().add("modified(ruleToHuman);");
		r.getActions().add("System.out.println(\"Fun��o MRE: Restri��o Interpreta��o\");");		
		r.getActions().add("flush();");
	...
	public static RuleInformation ruleConstrainInterpretation02(Goal goal, WrongAnswer wrongAnswer) {
		...
		r.getActions().add("ruleToHuman.setDescription(ruleToHuman.getDescription() + \"Regra acionada para classificar a Fun��o da MRE: " + r.getRuleName() + " \\n\");");
		r.getActions().add("ruleToHuman.setDescription(ruleToHuman.getDescription() + \" Condi��es:  \\n\");");
		r.getActions().add("ruleToHuman.setDescription(ruleToHuman.getDescription() + \" \\t Tipo de Erro = Indiretamente Identific�vel \\n\");");				
		//r.getActions().add("action.setAttempt(action.getAttempt() + 1);");
		//r.getActions().add("modified(action);");
		r.getActions().add("merFunction.setType(Constants.TIPO_FUNCAOMRE_RESTRICAO_INTERPRETACAO);");
		r.getActions().add("modified(merFunction);");
	...
	public static RuleInformation ruleConstructDeeperUndestanding01(Goal goal) {
		...
		r.getActions().add("ruleToHuman.setDescription(ruleToHuman.getDescription() + \"Regra acionada para classificar a Fun��o da MRE: " + r.getRuleName() + " \\n\");");
		r.getActions().add("ruleToHuman.setDescription(ruleToHuman.getDescription() + \" Condi��es:  \\n\");");
		r.getActions().add("ruleToHuman.setDescription(ruleToHuman.getDescription() + \" \\t Tipo de Erro = Diretamente Identific�vel - Defici�ncia na Regra \\n\");");				
		//r.getActions().add("action.setAttempt(action.getAttempt() + 1);");
		//r.getActions().add("modified(action);");
		r.getActions().add("merFunction.setType(Constants.TIPO_FUNCAOMRE_COMPREENSAO_MAIS_APROFUNDADA);");
		r.getActions().add("modified(merFunction);");
		r.getActions().add("modified(ruleToHuman);");
		r.getActions().add("System.out.println(\"Fun��o MRE: Compreens�o Mais Aprofundada\");");		
		r.getActions().add("flush();");
	...
	public static RuleInformation ruleConstructDeeperUndestanding02(Goal goal) {
		...
		r.getActions().add("ruleToHuman.setDescription(ruleToHuman.getDescription() + \"Regra acionada para classificar a Fun��o da MRE: " + r.getRuleName() + " \\n\");");
		r.getActions().add("ruleToHuman.setDescription(ruleToHuman.getDescription() + \" Condi��es:  \\n\");");
		r.getActions().add("ruleToHuman.setDescription(ruleToHuman.getDescription() + \" \\t Tipo de Erro = Diretamente Identific�vel - Defici�ncia na Escolha do Operador \\n\");");				
		//r.getActions().add("action.setAttempt(action.getAttempt() + 1);");
		//r.getActions().add("modified(action);");
		r.getActions().add("merFunction.setType(Constants.TIPO_FUNCAOMRE_COMPREENSAO_MAIS_APROFUNDADA);");
		r.getActions().add("modified(merFunction);");
	...
	public static RuleInformation ruleConstructDeeperUndestanding03(Goal goal) {
		...
		r.getActions().add("ruleToHuman.setDescription(ruleToHuman.getDescription() + \"Regra acionada para classificar a Fun��o da MRE: " + r.getRuleName() + " \\n\");");
		r.getActions().add("ruleToHuman.setDescription(ruleToHuman.getDescription() + \" Condi��es:  \\n\");");
		r.getActions().add("ruleToHuman.setDescription(ruleToHuman.getDescription() + \" \\t Tipo de Erro = Solu��o N�o Categoriz�vel \\n\");");			
		//r.getActions().add("action.setAttempt(action.getAttempt() + 1);");
		//r.getActions().add("modified(action);");
		r.getActions().add("merFunction.setType(Constants.TIPO_FUNCAOMRE_COMPREENSAO_MAIS_APROFUNDADA);");
		r.getActions().add("modified(merFunction);");
	...
	public static RuleInformation ruleMER(Goal goal, WrongAnswer wrongAnswer, MERFunction merFunction, MultipleExternalRepresentation mer) {
		...
		switch(merFunction.getType()){
			case Constants.TIPO_FUNCAOMRE_COMPREENSAO_MAIS_APROFUNDADA:
				strCondAux.add("\\tTipo de Fun��o de MRE = Compreens�o Mais Aprofundada");
				break;
			case Constants.TIPO_FUNCAOMRE_PAPEIS_COMPLEMENTARES:
				strCondAux.add("\\tTipo de Fun��o de MRE = Pap�is Complementares");
				break;
			case Constants.TIPO_FUNCAOMRE_RESTRICAO_INTERPRETACAO:	
				strCondAux.add("\\tTipo de Fun��o de MRE = Restri��o de Interpreta��o");
				break;
		}
		...
		switch(wrongAnswer.getType()){
			case Constants.TIPO_ERRO_DIRETAMENTE_IDENTIFICAVEL_DEFICIENCIA_DOMINIO:
				strCondAux.add("\\tTipo de Erro = Diretamente Identific�vel - Defici�ncia no Dom�nio");
				break;
			case Constants.TIPO_ERRO_DIRETAMENTE_IDENTIFICAVEL_DEFICIENCIA_ESCOLHA_OPERADOR:
				strCondAux.add("\\tTipo de Erro = Diretamente Identific�vel - Defici�ncia na Escolha do Operador");
				break;
			case Constants.TIPO_ERRO_DIRETAMENTE_IDENTIFICAVEL_DEFICIENCIA_REGRA:
				strCondAux.add("\\tTipo de Erro = Diretamente Identific�vel - Defici�ncia na Regra");
				break;
			case Constants.TIPO_ERRO_INDIRETAMENTE_IDENTIFICAVEL:
				strCondAux.add("\\tTipo de Erro = Indiretamente Identific�vel");
				break;
			case Constants.TIPO_ERRO_INTERPRETACAO_EQUIVOCADA:
				strCondAux.add("\\tTipo de Erro = Interpreta��o Equivocada");
				break;
			case Constants.TIPO_ERRO_SOLUCAO_NAO_CATEGORIZAVEL:
				strCondAux.add("\\tTipo de Erro = Solu��o N�o Categoriz�vel");
				break;
		}
		...
		r.getActions().add("modified(ruleToHuman);");
		r.getActions().add("System.out.println(\"Exibi��o de MRE " + mer.getId() + " - " + mer.getDescricao() + "\");");		
		r.getActions().add("flush();");
