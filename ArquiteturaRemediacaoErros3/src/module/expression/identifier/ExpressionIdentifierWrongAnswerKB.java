...
// rule necessary by default
    ...
    public boolean checkCondition(int ruleIndex, int condIndex) {
        switch (ruleIndex) {
            ...
            case 4: return wrongAnswer_default_cond(condIndex);
            default: return false;
        }
    }
    ...
    public boolean checkConditionsOnlyOf(int ruleIndex, int declIndex) {
        switch (ruleIndex) {
            ...
            case 4: return checkConditionsOnlyOf_wrongAnswer_default(declIndex);
            default: return false;
        }
    }
    ...
    public boolean checkCondForDeclaration(int ruleIndex, int declIndex) {
        switch (ruleIndex) {
            ...
            case 4: return checkCondForDeclaration_wrongAnswer_default(declIndex);
            default: return false;
        }
    }
    ...
    public String getDeclaredClassName(int ruleIndex, int declIndex) {
        switch (ruleIndex) {
            ...
            case 4: return getDeclaredClassName_wrongAnswer_default(declIndex);
            default: return null;
        }
    }
    ...
    public Class getDeclaredClass(int ruleIndex, int declIndex) {
        switch (ruleIndex) {
            ...
            case 4: return getDeclaredClass_wrongAnswer_default(declIndex);
            default: return null;
        }
    }
    ...
    protected void internalFireRule(int ruleIndex) {
        switch (ruleIndex) {
            ...
            case 4: wrongAnswer_default(); break;
        }
    }
    ...
    public String[] getDeclaredIdentifiers(int ruleIndex) {
        switch (ruleIndex) {
            ...
            case 4: return getDeclaredIdentifiers_wrongAnswer_default();
    ...
    public void setObject(int ruleIndex, int declIndex, Object value) {
        switch (ruleIndex) {
            ...
            case 4: setObject_wrongAnswer_default(declIndex, value); break;
        }
    }
    ...
    public Object getObject(int ruleIndex, int declIndex) {
        switch (ruleIndex) {
            ...
            case 4: return getObject_wrongAnswer_default(declIndex);
            default: return null;
        }
    }
    ...
    public Object[] getObjects(int ruleIndex) {
        switch (ruleIndex) {
            ...
            case 4: return getObjects_wrongAnswer_default();
            default: return null;
        }
    }
    /**
    ...
    public void setObjects(int ruleIndex, Object[] objects) {
        switch (ruleIndex) {
            ...
            case 4: setObjects_wrongAnswer_default(objects); break;
        }
    }
